...
export const ruleGroups: RuleGroup[] = [
  ...
  },
  {
    ...
    files: [
      ...
      {
        path: 'Surge/Ruleset/stream/video/embydirect.list',
      ...
      },
      {
        ...
        url: 'https://raw.githubusercontent.com/ConnersHua/RuleGo/master/Surge/Ruleset/Extra/stream/CN.list',
      },
      {
        path: 'Surge/Ruleset/stream/!cn.list',
        url: 'https://raw.githubusercontent.com/ConnersHua/RuleGo/master/Surge/Ruleset/Extra/stream/!CN.list',
  ...
  },
  {
    ...
    files: [
      ...
      */
      ...
      {
        path: 'Surge/Ruleset/LMFirefly_proxy.list',
...
export const specialRules: SpecialRuleConfig[] = [
  ...
  {
    name: 'Reject',
    targetFile: 'Surge/Ruleset/Block.list',
    sourceFiles: [
  ...
  {
    name: 'Streaming',
    targetFile: 'Surge/Ruleset/stream/streaming.list',
    sourceFiles: [
